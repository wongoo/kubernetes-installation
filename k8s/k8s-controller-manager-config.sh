...
sed -i "s#__K8S_MASTER_URL__#$K8S_MASTER_URL#g" /usr/lib/systemd/system/kube-controller-manager.service
sed -i "s#__K8S_CLUSTER_NAME__#$K8S_CLUSTER_NAME#g" /usr/lib/systemd/system/kube-controller-manager.service
